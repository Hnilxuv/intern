...
class manage_saving_accounts:
    ...
    def show_saving_account(self, list_sa):
        print("{:<15} {:<20} {:<15} {:<15} {:<15} {:<15}".format("Customer Id", "Name", "Account Number", "Balance",
                                                                 "Bank IR", "Link Code"))
        for i in list_sa:
            print("{:<15} {:<20} {:<15} {:<15} {:<15} {:<15}".format(i.id, i.name, i.account_number, i.balance, i.bir,
                                                                     i.link_code))
        print("\n")
...
class manage_checking_accounts:
    ...
    def show_saving_account(self, list_ca):
        print("{:<15} {:<20} {:<15} {:<15} {:<15}".format("Customer Id", "Name", "Account Number", "Balance",
                                                          "Link Code"))
        for i in list_ca:
